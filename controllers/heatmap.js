...
module.exports = {
  getHeatmap: async (req, res) => {
    ...
    try {
      ...
      firstDay.setMonth(firstDay.getMonth() - 7);
      console.log(`true first day: ${firstDay}`)
      let weekday = firstDay.getDay()
      console.log(`weekday: ${weekday}`)
      firstDay.setDate(firstDay.getDate() + (7 - weekday));
      console.log(firstDay)

      // changed weekdays to const, and wrote out the array
      const weekdays = ["Sunday", "Monday", "Tuesday", "Wednesday", "Thursday", "Friday", "Saturday"];

      // Loop for all days in the year for display on boxes, format short month name and date
